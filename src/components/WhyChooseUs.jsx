export default function WhyChooseUs() {
  return (
    <section className="w-full lg:max-w-[80%] mx-auto mt-24 flex flex-col space-y-6 px-0 lg:px-6">
      {/* Row 2: First set of cards */}
      <div className="flex flex-col md:flex-row md:space-x-6 space-y-6 md:space-y-0">
        {/* Left Card */}
        <div
          className="flex-1 md:flex-[7] rounded-[20px] h-64 flex flex-row items-center p-6"
          style={{border:"2px solid gray", background: 'linear-gradient(15deg, rgba(89, 89, 89, 1) 0%, rgba(245, 245, 245, 1) 100%)' }}
        >
          <div className="flex-1 pr-4">
            <h3 className="text-black font-[500] text-xl md:text-[45px] leading-[1] mb-[25px]">Save Money on Processing Fees</h3>
            <p className="text-white text-sm md:text-[20px]">We partner with multiple providers to secure the best rates and help you save $$$$.</p>
          </div>
      ...
      <div className="flex flex-col md:flex-row md:space-x-6 space-y-6 md:space-y-0">
        ...
        >
          <div className="flex-1 pr-4">
            <h3 className="text-black font-[500] text-xl md:text-[45px] leading-[1] mb-[25px]">Pass Fees to Customers</h3>
            <p className="text-white text-sm md:text-[20px]">If it's right for your business, we can show you how to legally pass credit card fees along to your customers.</p>
          </div>
          <div className="flex-1 h-full flex items-center justify-center">
